...
Output: blind_izar_100ep_preview.json
"""
...
OUT = "/scratch/wxu/habitat_checkpoints_rcp/analysis_results/blind_izar_100ep_preview.json"
...
out = {"source": "blind_izar (partial, 100ep checkpoint)", "ckpt": "ckpt.34", "n_episodes": int(len(np.unique(ep)))}

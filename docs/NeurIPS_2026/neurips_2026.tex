...
{\footnotesize (d) The 5 conditions on the same Gibson val episode (scene 92, ep 414), each chosen so that all 5 SPLs sit within $\pm 0.10$ of their respective per-condition median --- i.e.\ all five are typical successful runs. Bottleneck conditions (blind 231 steps, matched 146) take winding paths consistent with planning from an integrated map; rich-encoder conditions (uniform / foveated / fov-learned, 77--80 steps) take near-direct paths.}
\end{minipage}

...
<https://github.com/alunxu/sensor-cogmap-coupling>.
...
# --- companion code (sensor-cogmap-coupling repo) provides these helpers ----
...
(<https://github.com/alunxu/sensor-cogmap-coupling>) is released under its own

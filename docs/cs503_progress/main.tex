...
\textbf{Analysis:} Freeze weights $\to$ collect per-step LSTM hidden states $\to$ linear probing (Ridge regression, episode-level splits) for spatial variables $\to$ cross-condition CKA and probe transfer $\to$ behavioral tests $\to$ PCA/t-SNE visualization.
